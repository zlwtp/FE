...
module.exports = option => {
    ...
    const { styleLoader, cssLoader, sassLoader, postcssLoader, cssLoader_module, styleLoader_insertbefore, styleLoader_insertbefore_transformSkin, cssExtractLoader, postcssLoader_color2var } = require('./loader/style')
